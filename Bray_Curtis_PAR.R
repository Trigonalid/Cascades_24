...
# View the results
print(bray_curtis_results_cat)


bray_curtis_values_cat <- sapply(bray_curtis_results_cat, function(mat) mat[1, 2])
mean_bray_curtis_cat <- mean(bray_curtis_values_cat) ; mean_bray_curtis_cat 
sd_bray_curtis_CAT <-sd(bray_curtis_values_cat) # 0.007957034

# Print the mean Bray-Curtis dissimilarity
print(mean_bray_curtis_cat) # 0.2295633
