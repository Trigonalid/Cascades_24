...
# Parasitoid - Caterpillar - all data
```{r Data load}
main_table <- MASTER <- read_excel("DATA/MASTER.xlsx") %>% as_tibble()
main_table <- main_table %>%
  dplyr::select(locality, PAR_sp, CAT_sp, PLANT_sp)


Distance<- read.csv("DATA/input/distance_data.csv", row.names = 1)

rownames(Distance) <- colnames(Distance)

# Melt the data frame to long format
distance_plot <- as.data.frame(as.table(as.matrix(Distance)))
colnames(distance_plot) <- c("Locality1", "Locality2", "Distance")
```
...
Elem3_full_PC<-as.matrix(table(Elem_full_PC$CAT_sp,Elem_full_PC$PAR_sp)) # prepare the table
...
FW_full_CP_results<-betalinkr_multi(webs2array(Elem3_full_CP,Morox3_full_CP,Niksek3_full_CP,Ohu13_full_CP,Ohu2_3_full_CP,Utai3_full_CP, Wamangu3_full_CP, Wanang3_full_CP, Yapsiei3_full_CP), partitioning="commondenom", partition.st=TRUE)
...
FW_OS_full_CP_2 <- rename(FW_OS_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_full_CP_2 <- rename(FW_WN_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_full_CP_2 <- rename(FW_ST_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_full_CP_2 <- rename(FW_ST.l_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_full_CP_2 <- rename(FW_ST.h_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_full_CP_2 <- rename(FW_ST.lh_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
# 50+ Parasitoid - Caterpillar - reduced to common caterpillars
```{r}
main_table <- MASTER <- read_excel("DATA/MASTER.xlsx") %>% as_tibble()
...
FW_common_cat_PC_results<-betalinkr_multi(webs2array(Elem3_common_cat_PC,Morox3_common_cat_PC,Niksek3_common_cat_PC,Ohu13_common_cat_PC,Ohu2_3_common_cat_PC,Utai3_common_cat_PC, Wamangu3_common_cat_PC, Wanang3_common_cat_PC, Yapsiei3_common_cat_PC), partitioning="commondenom", partition.st=TRUE)
FW_common_cat_PC_results<-FW_common_cat_PC_results %>% add_column(dataset = "whole_CAT_PLANT")
...
FW_OS_common_cat_PC_2 <- rename(FW_OS_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_common_cat_PC_2 <- rename(FW_WN_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_common_cat_PC_2 <- rename(FW_ST_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_common_cat_PC_2 <- rename(FW_ST.l_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_common_cat_PC_2 <- rename(FW_ST.h_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_common_cat_PC_2 <- rename(FW_ST.lh_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
# 50+ Caterpillar- Plant - reduced to common caterpillars 50+
```{r}
main_table <- MASTER <- read_excel("DATA/MASTER.xlsx") %>% as_tibble()
...
FW_common_cat_CPL_results<-betalinkr_multi(webs2array(Elem3_common_cat_CPL,Morox3_common_cat_CPL,Niksek3_common_cat_CPL,Ohu13_common_cat_CPL,Ohu2_3_common_cat_CPL,Utai3_common_cat_CPL, Wamangu3_common_cat_CPL, Wanang3_common_cat_CPL, Yapsiei3_common_cat_CPL), partitioning="commondenom", partition.st=TRUE)
...
FW_OS_common_cat_CPL_2 <- rename(FW_OS_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_common_cat_CPL_2 <- rename(FW_WN_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_common_cat_CPL_2 <- rename(FW_ST_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_common_cat_CPL_2 <- rename(FW_ST.l_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_common_cat_CPL_2 <- rename(FW_ST.h_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_common_cat_CPL_2 <- rename(FW_ST.lh_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_4plus_PC_results<-betalinkr_multi(webs2array(Elem3_4plus_PC,Morox3_4plus_PC,Niksek3_4plus_PC,Ohu13_4plus_PC,Ohu2_3_4plus_PC,Utai3_4plus_PC, Wamangu3_4plus_PC, Wanang3_4plus_PC, Yapsiei3_4plus_PC), partitioning="commondenom", partition.st=TRUE)
...
FW_OS_4plus_PC_2 <- rename(FW_OS_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_4plus_PC_2 <- rename(FW_WN_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_4plus_PC_2 <- rename(FW_ST_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_4plus_PC_2 <- rename(FW_ST.l_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_4plus_PC_2 <- rename(FW_ST.h_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_4plus_PC_2 <- rename(FW_ST.lh_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_4plus_CPL_results<-betalinkr_multi(webs2array(Elem3_4plus_CPL,Morox3_4plus_CPL,Niksek3_4plus_CPL,Ohu13_4plus_CPL,Ohu2_3_4plus_CPL,Utai3_4plus_CPL, Wamangu3_4plus_CPL, Wanang3_4plus_CPL, Yapsiei3_4plus_CPL), partitioning="commondenom", partition.st=TRUE)
...
FW_OS_4plus_CPL_2 <- rename(FW_OS_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_4plus_CPL_2 <- rename(FW_WN_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_4plus_CPL_2 <- rename(FW_ST_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_4plus_CPL_2 <- rename(FW_ST.l_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_4plus_CPL_2 <- rename(FW_ST.h_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_4plus_CPL_2 <- rename(FW_ST.lh_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
combined_results_FULL_PAR_CAT$Dataset   <-"PAR-CAT"
combined_results_FULL_CAT_PLANT$Dataset <-"CAT-PLANT"
combined_results_common_cat_PC$Dataset  <-"PAR-CAT"
combined_results_common_cat_CPL$Dataset  <-"CAT-PLANT"
combined_results_4plus_PC$Dataset  <-"PAR-CAT"
combined_results_4plus_CPL$Dataset <-"CAT-PLANT"
...
Figure_Sx <- ggplot(Figure_SX_data, aes(x = distance, y = hodnota, 
                           color = guild) )+
 ...
 geom_smooth(method = "lm", se = FALSE, aes(group = guild), formula = y ~ x, fullrange = TRUE) +
  ...
  labs(x = "Distance", y = "hodnota", title = "") +
